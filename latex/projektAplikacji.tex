...
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[scale=0.6]{tabelaprog1}
	}
...
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[scale=0.6]{tabelaprog2}
	}
...
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[scale=0.6]{tabelamech1}
	}
...
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[scale=0.6]{tabelamech2}
	}
...
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[scale=0.6]{tabelabiol1}
	}
...
\begin{figure}[h!]
	\makebox[\textwidth][c]{\includegraphics[scale=0.6]{tabelabiol2}
	}
